...
export default function CoverLetter() {
    return (
        <div className="lg:w-2/3 2xl:w-1/2">
            ...
            <p className="font-body text-paragraph pb-5 leading-relaxed">
